...
using dotmeer.AliceApi.Models.Capabilities.ColorSetting;
using dotmeer.AliceApi.Models.Capabilities.Mode;
using dotmeer.AliceApi.Models.Capabilities.OnOff;
using dotmeer.AliceApi.Models.Capabilities.Range;
using dotmeer.AliceApi.Models.Capabilities.Toggle;
using dotmeer.AliceApi.Models.Capabilities.VideoStream;
